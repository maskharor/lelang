...
<head>
    ...
    <title>ADMIN-Dt masyarakat</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="register_masyarakat.php" class="btn btn-success">Tambah Data</a>
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td><?=$no?></td>
                                        <td><?=$data_masyarakat['nama_masyarakat']?></td>
                                        <td><?=$data_masyarakat['username']?></td>
                                        <td><?=$data_masyarakat['tlp']?></td>
                                        <td>
                                            <a href="ubah_masyarakat.php?id_masyarakat=<?=$data_masyarakat['id_masyarakat']?>" class="btn btn-primary">Ubah</a>
                                            <a href="hapus_masyarakat.php?id_masyarakat=<?=$data_masyarakat['id_masyarakat']?>" onclick="return Sconfirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
