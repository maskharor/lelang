        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="text-left">
                                <a class="small" href="data_petugas.php"><- kembali ke data petugas</a>
                    </div>
                    <!-- Page Heading -->
                    <?php
                        include "../koneksi.php";
                        ...
                        <?php 
                            ...
                            <select name="level" class="form-control">
                                ...
                                <?php foreach ($arr_level as $key_level => $val_level):
                                    ...
                                    if($key_level==$data_petugas['level']){
                            ...
                            <br>
                            <input type="submit" name="simpan" value="Ubah Siswa" class="btn btn-success">
                    </form>
