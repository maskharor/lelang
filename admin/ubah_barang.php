    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Lelang ED - ADMIN</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMenu" class="collapse" aria-labelledby="headingMenu" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="data_petugas.php">Barang lelang</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="text-left">
                                <a class="small" href="data_masyarakat.php"><- kembali ke data masyarakat</a>
                    </div>
                    <!-- Page Heading -->
                    <?php
                        include "../koneksi.php";
                        $qry_get_masyarakat=mysqli_query($conn, "select * from masyarakat where id_masyarakat = '".$_GET['id_masyarakat']."' ");
                        $data_masyarakat=mysqli_fetch_array($qry_get_masyarakat);
                    ?>
                    <h3>Ubah Data</h3>
                    <form action="proses_ubah_masyarakat.php" method="post">
                        <input type="hidden" name="id_masyarakat" value="<?=$data_masyarakat['id_masyarakat']?>">
                        Nama : 
                        <input type="text" name="nama_masyarakat" value="<?=$data_masyarakat['nama_masyarakat']?>" class="form-control">
                        Username :
                        <input type="text" name="username" value="<?=$data_masyarakat['username']?>" class="form-control">
                        Password : 
                        <input type="password" name="password" value="" class="form-control">
                        No.Telepon :
                        <input type="number" name="tlp" value="<?=$data_masyarakat['tlp']?>" class="form-control">
