        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h3>Data Petugas</h3>
                    <a href="register_petugas.php" class="btn btn-success">Tambah Data</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                                <a href="ubah_petugas.php?id=<?=$data_petugas['id']?>" class="btn btn-primary">Ubah</a>
                                                <a href="hapus_petugas.php?id=<?=$data_petugas['id']?>" onclick="return Sconfirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
